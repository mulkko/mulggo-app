...
#
# 입력 : data/processed/business_code_chroma_reference_v1.csv   (`prepare_business_code_chroma_reference.py` 출력, 1,612행)
#        data/processed/ksic_haeseol_v1.json                    (`parse_ksic_haeseol.py` 출력)
# =============================================================================
...
def first_value(v: object) -> str:
    """'A | B | C' -> 'A' (`prepare_business_code_chroma_reference.py`가 다중 값을 파이프로 합쳐 놓음)."""
