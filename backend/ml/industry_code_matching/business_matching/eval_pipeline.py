"""
eval_pipeline.py — 개정 계획서 §10.5 E안 + §10.6 지표, 문헌 기준(docs/평가근거_문헌표.md §2) 대조.
...
사용:
    ...
    python business_matching/eval_pipeline.py --gold business_matching/gold_set_v1.csv --limit 10
