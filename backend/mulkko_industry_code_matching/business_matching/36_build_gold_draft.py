"""
36_build_gold_draft.py — 개정 계획서 §10.2~10.4.
...
사용:
    python business_matching/36_build_gold_draft.py                 # 200건
    python business_matching/36_build_gold_draft.py --n 20 --dry     # 스모크(20건)
...
def main() -> None:
    ...
    print("다음: 사람_확정_* 칸 채우고 사람_검수완료=Y → 37_finalize_gold.py")
