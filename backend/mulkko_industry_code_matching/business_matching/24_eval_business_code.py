...
#
# 사용
#   python 24_eval_business_code.py
#   python 24_eval_business_code.py --gold gold_set_v1.csv --limit 5
#
...
V3_PATH = SCRIPT_DIR / "23_match_business_code_v3.py"
DEFAULT_GOLD = SCRIPT_DIR / "gold_set_v1.csv"
DEFAULT_OUT_DIR = PROJECT_ROOT / "data" / "outputs"

POOL_RECALL_K = None  # None이면 23번의 RERANK_TOP_N(재판정 후보 수)을 그대로 쓴다
