"""
42_method_ablation.py — 개정 계획서 §10.5 (A~E 방법 비교).
...
사용:
    python business_matching/42_method_ablation.py --gold business_matching/gold_set_v3_sub90.csv
"""
...
def main() -> None:
    ...
    if ej.exists():
        ...
        rows.append({"방식": "E. + LLM 재판정 (전체)", "Top-1": f"(먼저 38번 실행: {ej.name})",
                     "Recall@3": "", "Recall@20": ""})
