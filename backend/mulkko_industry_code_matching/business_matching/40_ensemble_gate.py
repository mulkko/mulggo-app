"""
40_ensemble_gate.py — 앙상블 게이트 오프라인 분석. **LLM 안 씀. 크레딧 0.**
...
사용:
  python business_matching/40_ensemble_gate.py --gold business_matching/gold_set_v3_auto.csv
"""
...
def main() -> None:
    ...
    if not eval_json.exists():
        raise SystemExit(f"{eval_json} 없음. 먼저 38_eval_pipeline.py 를 이 gold 로 실행하세요.")
