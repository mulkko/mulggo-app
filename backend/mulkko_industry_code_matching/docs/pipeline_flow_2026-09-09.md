...
- 파이프라인 본체: `business_matching/23_match_business_code_v3.py`
...
industry_matcher.py                         (백엔드 진입점, 변경 없음)
  └─ import 23_match_business_code_v3.py     ← 여기에 상수+hierarchy_fit()+5줄 추가
        │
        ├─ (동결) 23_match_business_code_v3_baseline_20260909.py   ← 롤백·대조 기준
        │
